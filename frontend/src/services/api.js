...
export const billingAPI = {
  ...
  processCustomPayment: (data) => api.post('/billing/custom-payment', data),
...
export const socialHubAPI = {
  ...
  getPostAIToggles: () => api.get('/social-hub/posts/ai-toggles'),
  togglePostAI: (data) => api.post('/social-hub/posts/ai-toggle', data),
   // AI-powered
