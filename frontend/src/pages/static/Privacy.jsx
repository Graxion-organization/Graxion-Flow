    ...
    >
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        <div style={{ marginBottom: "60px", padding: "40px", borderRadius: "32px", background: "rgba(37, 211, 102, 0.05)", border: "1px solid rgba(37, 211, 102, 0.2)" }}>
          <p style={{ fontSize: "17px", lineHeight: 1.8, color: "#e8f5ee", margin: 0, paddingBottom: "16px" }}>
          ...
          <p style={{ fontSize: "17px", lineHeight: 1.8, color: "#e8f5ee", margin: 0, paddingBottom: "16px" }}>
            <strong>Meta (Facebook, Instagram, WhatsApp) Permissions:</strong> Graxion Flow accesses your Meta accounts to provide omnichannel marketing, content scheduling, and CRM features. By connecting these services, you allow us to manage your pages, read and respond to messages, and publish content on your behalf. This data is handled in strict compliance with Meta's Developer Policies. We never sell your Meta data to third parties. You can revoke our access at any time through your Facebook or Instagram security settings.
          </p>
          <p style={{ fontSize: "17px", lineHeight: 1.8, color: "#e8f5ee", margin: 0 }}>
            <strong>Google & YouTube API Services:</strong> Graxion Flow uses YouTube API Services to allow you to automate your YouTube channel. By using our YouTube integration, you agree to be bound by the <a href="https://www.youtube.com/t/terms" target="_blank" rel="noopener noreferrer" style={{ color: "#25D366" }}>YouTube Terms of Service</a>. We access and use your YouTube channel data solely to provide automation services (such as scheduling Shorts and managing comments). We do not share your YouTube data with external third parties. Graxion Flow's use and transfer to any other app of information received from Google APIs will adhere to the <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer" style={{ color: "#25D366" }}>Google API Services User Data Policy</a>, including the Limited Use requirements. You can learn more about how Google handles your data by reviewing the <a href="http://www.google.com/policies/privacy" target="_blank" rel="noopener noreferrer" style={{ color: "#25D366" }}>Google Privacy Policy</a>. You can revoke our access to your Google/YouTube account at any time via the <a href="https://security.google.com/settings/security/permissions" target="_blank" rel="noopener noreferrer" style={{ color: "#25D366" }}>Google Security Settings page</a>.
          </p>
        </div>
