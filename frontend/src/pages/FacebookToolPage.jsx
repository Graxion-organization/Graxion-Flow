  ...
  return (
    <div className="h-[calc(100vh-120px)] flex flex-col gap-6 pb-6">
      ...
      {selectedAccount && (
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="font-bold text-lg text-gray-100">{selectedAccount.pageName || 'Unknown Page'}</h2>
      ...
      {loadingAccounts && !selectedAccount ? (
        ...
        <div className="flex-1 flex justify-center items-center text-gray-500">No connected pages found. Connect a page first.</div>
      ) : (
