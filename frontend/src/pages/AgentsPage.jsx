...
const agentSchema = z.object({
  ...
  whatsappAccountIds:  z.array(z.string()).nullish(),
  telegramAccountId:   z.string().nullish(),
  instagramAccountId:  z.string().nullish(),
  facebookAccountId:   z.string().nullish(),
  youtubeAccountId:    z.string().nullish(),
  ...
  greetingMessage:     z.string().max(1000).nullish(),
  humanHandoffKeywords:z.string().nullish(),
...
function AgentFormModal({ onClose, onSave, editingAgent, connectedPlatforms, waAccounts, tgAccounts, igAccounts, fbAccounts, ytAccounts, lnAccounts, isDark, initialPlatform }) {
  ...
  const { register, handleSubmit, watch, setValue, formState: { errors, isSubmitting } } = useForm({
    ...
    defaultValues: editingAgent ? {
      ...
      whatsappAccountIds: editingAgent.whatsappAccounts?.map(a => a._id || a) || (editingAgent.whatsappAccount ? [editingAgent.whatsappAccount._id || editingAgent.whatsappAccount] : []) || undefined,
      telegramAccountId: editingAgent.telegramAccount?._id || editingAgent.telegramAccount || undefined,
      instagramAccountId: editingAgent.instagramAccount?._id || editingAgent.instagramAccount || undefined,
      facebookAccountId: editingAgent.facebookAccount?._id || editingAgent.facebookAccount || undefined,
      youtubeAccountId: editingAgent.youtubeAccount?._id || editingAgent.youtubeAccount || undefined,
      linkedinAccountId: editingAgent.linkedinAccount?._id || editingAgent.linkedinAccount || undefined,
      description: editingAgent.description || undefined,
      fallbackMessage: editingAgent.fallbackMessage || undefined,
      greetingMessage: editingAgent.greetingMessage || undefined,
