  ...
  try {
    ...
    waAccounts.forEach(acc => {
      accounts.push({
        ...
        avatar: acc.profilePictureUrl || 'https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg',
        type: 'Business API',
        status: acc.status,
        modelId: acc._id,
        tokenValidity: acc.status === 'error' ? 'expired' : 'valid',
    ...
    tgAccounts.forEach(acc => {
      accounts.push({
        ...
        avatar: acc.botPhotoUrl || 'https://upload.wikimedia.org/wikipedia/commons/8/82/Telegram_logo.svg',
        type: 'Bot API',
        status: acc.status,
        modelId: acc._id,
        tokenValidity: acc.status === 'error' ? 'expired' : 'valid',
    ...
    if (youtubeAccount) {
      accounts.push({
        ...
        avatar: youtubeAccount.channelThumbnail || 'https://upload.wikimedia.org/wikipedia/commons/0/09/YouTube_full-color_icon_%282017%29.svg',
    ...
    liAccounts.forEach(acc => {
      accounts.push({
        ...
        avatar: acc.profilePicture || 'https://upload.wikimedia.org/wikipedia/commons/c/ca/LinkedIn_logo_initials.png',
