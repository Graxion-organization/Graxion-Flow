...
const componentsDir = path.join(__dirname, 'src', 'components', 'settings');
if (!fs.existsSync(componentsDir)) {
  fs.mkdirSync(componentsDir, { recursive: true });
}

const teamMembers = `import React, { useState, useEffect } from 'react';
...
fs.writeFileSync(path.join(componentsDir, 'TeamMembers.jsx'), teamMembers);
console.log('Created TeamMembers.jsx');
