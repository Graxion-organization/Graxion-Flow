...
const generateResponse = async (prompt, contextData) => {
  ...
  try {
    ...
    console.warn('Gemini 2.5 Flash failed, attempting fallback to OpenRouter (DeepSeek)...', error.message);
    ...
    try {
      ...
      console.error('OpenRouter fallback failed:', openRouterError.message);
